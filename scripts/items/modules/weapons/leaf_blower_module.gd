...
# The type of module.
@export var module_type: String = "Leaf Blower"
...
func _ready() -> void:
	if GameState.has_weapon("Leaf Blower"):
		queue_free()
...
func pickup_module() -> void:
	...
	if player:
		...
		cutscene_instance.module_name = "Picked up the Leaf Blower module!"
		cutscene_instance.module_description = "Shoots three rapid leaves that each deal 1 damage."
